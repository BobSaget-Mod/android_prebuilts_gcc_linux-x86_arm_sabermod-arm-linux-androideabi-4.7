...
#endif
#ifdef GENERATOR_FILE
extern int flag_pmu_profile_use;
#else
  int x_flag_pmu_profile_use;
#define flag_pmu_profile_use global_options.x_flag_pmu_profile_use
#endif
#ifdef GENERATOR_FILE
extern const char *pmu_profile_data;
#else
  const char *x_pmu_profile_data;
#define pmu_profile_data global_options.x_pmu_profile_data
#endif
#ifdef GENERATOR_FILE
...
#else
  const char *x_flag_tsan_ignore;
#define flag_tsan_ignore global_options.x_flag_tsan_ignore
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int dwarf_accel_tables;
#else
  int x_dwarf_accel_tables;
#define dwarf_accel_tables global_options.x_dwarf_accel_tables
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Wforce_warnings = 221,                 /* -Wforce-warnings */
  ...
  OPT_Wliteral_suffix = 258,                 /* -Wliteral-suffix */
  ...
  OPT_Wraw = 309,                            /* -Wraw */
  OPT_Wreal_conversion = 310,                /* -Wreal-conversion */
  ...
  OPT_Wripa_opt_mismatch = 316,              /* -Wripa-opt-mismatch */
  OPT_Wselector = 317,                       /* -Wselector */
  OPT_Wself_assign = 318,                    /* -Wself-assign */
  OPT_Wself_assign_non_pod = 319,            /* -Wself-assign-non-pod */
  OPT_Wsequence_point = 320,                 /* -Wsequence-point */
  OPT_Wserial = 321,                         /* -Wserial */
  OPT_Wshadow = 322,                         /* -Wshadow */
  OPT_Wshadow_compatible_local = 323,        /* -Wshadow-compatible-local */
  OPT_Wshadow_local = 324,                   /* -Wshadow-local */
  OPT_Wsign_compare = 325,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 326,                /* -Wsign-conversion */
  OPT_Wsign_promo = 327,                     /* -Wsign-promo */
  OPT_Wspecial_param_hiding = 328,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 329,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 330,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 331,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 332,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 333,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 334,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 335,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 336,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 337,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 338,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 339,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 340,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 341,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 342,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 343,                       /* -Wsuppress */
  OPT_Wsurprising = 344,                     /* -Wsurprising */
  OPT_Wswitch = 345,                         /* -Wswitch */
  OPT_Wswitch_default = 346,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 347,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 348,                      /* -Wsync-nand */
  OPT_Wsynth = 349,                          /* -Wsynth */
  OPT_Wsynthetic_access = 350,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 351,                 /* -Wsystem-headers */
  OPT_Wtabs = 352,                           /* -Wtabs */
  OPT_Wtasks = 353,                          /* -Wtasks */
  OPT_Wthread_attr_bind_param = 354,         /* -Wthread-attr-bind-param */
  OPT_Wthread_mismatched_lock_acq_rel = 355, /* -Wthread-mismatched-lock-acq-rel */
  OPT_Wthread_mismatched_lock_order = 356,   /* -Wthread-mismatched-lock-order */
  OPT_Wthread_reentrant_lock = 357,          /* -Wthread-reentrant-lock */
  OPT_Wthread_safety = 358,                  /* -Wthread-safety */
  /* OPT_Wthread_safety_analysis = 359, */   /* -Wthread-safety-analysis */
  /* OPT_Wthread_safety_attributes = 360, */ /* -Wthread-safety-attributes */
  /* OPT_Wthread_safety_precise = 361, */    /* -Wthread-safety-precise */
  OPT_Wthread_unguarded_func = 362,          /* -Wthread-unguarded-func */
  OPT_Wthread_unguarded_var = 363,           /* -Wthread-unguarded-var */
  OPT_Wthread_unsupported_lock_name = 364,   /* -Wthread-unsupported-lock-name */
  ...
  /* OPT_Xclang_only_ = 409, */              /* -Xclang-only= */
  ...
  OPT_c = 419,                               /* -c */
  OPT_canonical_prefixes = 420,              /* -canonical-prefixes */
  ...
  OPT_fauto_profile = 468,                   /* -fauto-profile */
  OPT_fauto_profile_ = 469,                  /* -fauto-profile= */
  ...
  OPT_fclone_hot_version_paths = 495,        /* -fclone-hot-version-paths */
  ...
  OPT_ffunction_attribute_list_ = 607,       /* -ffunction-attribute-list= */
  ...
  OPT_fipa_cp = 666,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 667,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 668,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 669,                    /* -fipa-profile */
  OPT_fipa_pta = 670,                        /* -fipa-pta */
  OPT_fipa_pure_const = 671,                 /* -fipa-pure-const */
  OPT_fipa_reference = 672,                  /* -fipa-reference */
  OPT_fipa_sra = 673,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 674, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 675,                 /* -fira-algorithm= */
  ...
  OPT_fopt_info = 744,                       /* -fopt-info */
  OPT_fopt_info_ = 745,                      /* -fopt-info= */
  OPT_foptimize_locality = 746,              /* -foptimize-locality */
  OPT_foptimize_register_move = 747,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 748,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 749,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 750,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 751, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 752,              /* -foutput-class-dir= */
  OPT_fpack_derived = 753,                   /* -fpack-derived */
  OPT_fpack_struct = 754,                    /* -fpack-struct */
  OPT_fpack_struct_ = 755,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 756,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 757,              /* -fpcc-struct-return */
  OPT_fpch_deps = 758,                       /* -fpch-deps */
  OPT_fpch_preprocess = 759,                 /* -fpch-preprocess */
  OPT_fpeel_codesize_limit = 760,            /* -fpeel-codesize-limit */
  OPT_fpeel_loops = 761,                     /* -fpeel-loops */
  OPT_fpeephole = 762,                       /* -fpeephole */
  OPT_fpeephole2 = 763,                      /* -fpeephole2 */
  OPT_fpermissive = 764,                     /* -fpermissive */
  OPT_fpic = 765,                            /* -fpic */
  OPT_fpie = 766,                            /* -fpie */
  OPT_fplan9_extensions = 767,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 768,                    /* -fplugin-arg- */
  OPT_fplugin_ = 769,                        /* -fplugin= */
  OPT_fpmu_profile_generate_ = 770,          /* -fpmu-profile-generate= */
  OPT_fpmu_profile_use = 771,                /* -fpmu-profile-use */
  OPT_fpmu_profile_use_ = 772,               /* -fpmu-profile-use= */
  ...
  OPT_fprofile_dump = 783,                   /* -fprofile-dump */
  OPT_fprofile_gen_atomic_ = 784,            /* -fprofile-gen-atomic= */
  OPT_fprofile_generate = 785,               /* -fprofile-generate */
  OPT_fprofile_generate_sampling = 786,      /* -fprofile-generate-sampling */
  OPT_fprofile_generate_ = 787,              /* -fprofile-generate= */
  OPT_fprofile_reusedist = 788,              /* -fprofile-reusedist */
  OPT_fprofile_strip_ = 789,                 /* -fprofile-strip= */
  ...
  OPT_frecord_gcc_switches_in_elf = 806,     /* -frecord-gcc-switches-in-elf */
  ...
  OPT_freorder_functions_ = 818,             /* -freorder-functions= */
  ...
  OPT_fripa = 827,                           /* -fripa */
  OPT_fripa_disallow_asm_modules = 828,      /* -fripa-disallow-asm-modules */
  OPT_fripa_disallow_opt_mismatch = 829,     /* -fripa-disallow-opt-mismatch */
  OPT_fripa_inc_path_sub_ = 830,             /* -fripa-inc-path-sub= */
  OPT_fripa_no_promote_always_inline_func = 831,/* -fripa-no-promote-always-inline-func */
  ...
  OPT_fsized_delete = 874,                   /* -fsized-delete */
  ...
  OPT_fstrict_enum_precision = 896,          /* -fstrict-enum-precision */
  ...
  OPT_g = 1005,                              /* -g */
  OPT_gaccel_tables = 1006,                  /* -gaccel-tables */
  OPT_gant = 1007,                           /* -gant */
  OPT_gcoff = 1008,                          /* -gcoff */
  OPT_gdwarf_ = 1009,                        /* -gdwarf- */
  OPT_gen_decls = 1010,                      /* -gen-decls */
  /* OPT_gfission = 1011, */                 /* -gfission */
  OPT_ggdb = 1012,                           /* -ggdb */
  OPT_ggnu_pubnames = 1013,                  /* -ggnu-pubnames */
  OPT_gmlt = 1014,                           /* -gmlt */
  OPT_gnat = 1015,                           /* -gnat */
  OPT_gnatO = 1016,                          /* -gnatO */
  OPT_gno_accel_tables = 1017,               /* -gno-accel-tables */
  /* OPT_gno_fission = 1018, */              /* -gno-fission */
  ...
  OPT_mabi_ = 1048,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1049,             /* -mabort-on-noreturn */
  OPT_mandroid = 1050,                       /* -mandroid */
  ...
  OPT_mcirrus_fix_invalid_insns = 1062,      /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 1063,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1064,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1065,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1066,                  /* -mfp16-format= */
  /* OPT_mfp_2 = 1067, */                    /* -mfp=2 */
  /* OPT_mfp_3 = 1068, */                    /* -mfp=3 */
  OPT_mfpe = 1069,                           /* -mfpe */
  /* OPT_mfpe_2 = 1070, */                   /* -mfpe=2 */
  /* OPT_mfpe_3 = 1071, */                   /* -mfpe=3 */
  OPT_mfpu_ = 1072,                          /* -mfpu= */
  ...
  OPT_mpic_register_ = 1077,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1078,            /* -mpoke-function-name */
  ...
  OPT_std_c__98 = 1147,                      /* -std=c++98 */
  OPT_std_c11 = 1148,                        /* -std=c11 */
  /* OPT_std_c1x = 1149, */                  /* -std=c1x */
  /* OPT_std_c89 = 1150, */                  /* -std=c89 */
  OPT_std_c90 = 1151,                        /* -std=c90 */
  OPT_std_c99 = 1152,                        /* -std=c99 */
  /* OPT_std_c9x = 1153, */                  /* -std=c9x */
  OPT_std_f2003 = 1154,                      /* -std=f2003 */
  OPT_std_f2008 = 1155,                      /* -std=f2008 */
  OPT_std_f2008ts = 1156,                    /* -std=f2008ts */
  OPT_std_f95 = 1157,                        /* -std=f95 */
  OPT_std_gnu = 1158,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1159, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1160, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1161,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1162,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1163,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1164, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1165, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1166,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1167,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1168, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1169, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1170,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1171, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1172, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1173, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1174,                     /* -std=legacy */
  OPT_symbolic = 1175,                       /* -symbolic */
  OPT_t = 1176,                              /* -t */
  OPT_time = 1177,                           /* -time */
  OPT_time_ = 1178,                          /* -time= */
  OPT_tno_android_cc = 1179,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1180,                 /* -tno-android-ld */
  OPT_traditional = 1181,                    /* -traditional */
  OPT_traditional_cpp = 1182,                /* -traditional-cpp */
  OPT_trigraphs = 1183,                      /* -trigraphs */
  OPT_u = 1184,                              /* -u */
  OPT_undef = 1185,                          /* -undef */
  OPT_v = 1186,                              /* -v */
  OPT_version = 1187,                        /* -version */
  OPT_w = 1188,                              /* -w */
  OPT_wrapper = 1189,                        /* -wrapper */
  OPT_x = 1190,                              /* -x */
  OPT_z = 1191,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
